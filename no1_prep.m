function [source, kgrid, model, t1_img, ppw, cfl, shift_x, shift_y, ...
    shift_z] = no1_prep(ct_filename, t1_filename, focus_coords, bowl_coords, )
% --------------------
% SKULL MODEL
% --------------------
...
return source, kgrid, freq, model, t1_img, record_periods, ppp, medium, rho_min, c_min, pulse_length, pulse_rep_freq